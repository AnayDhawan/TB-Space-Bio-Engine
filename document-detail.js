...
function loadPDF() {
    const pdfPath = `${currentDoc.filename}`;
    ...
    pdfjsLib.getDocument(pdfPath).promise.then(pdf => {
        ...
        document.getElementById('pdfLoading').innerHTML = `
            ...
            <p style="font-size: 14px; margin-top: 10px;">Some files are not available on the prototype version. ${currentDoc.filename} <br> Download from the github version to view this PDF</p>
        `;
    });
}
